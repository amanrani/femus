...
geompy.addToStudyInFather( Translation_1, Face_6, 'Face_6' )
geompy.addToStudyInFather( Translation_1, Face_7, 'Face_7' )
geompy.addToStudyInFather( Translation_1, Face_8, 'Face_8' )
geompy.addToStudyInFather( Translation_1, Face_9, 'Face_9' )
geompy.addToStudyInFather( Translation_1, Face_10, 'Face_10' )
geompy.addToStudyInFather( Translation_1, Face_11, 'Face_11' )
geompy.addToStudyInFather( Translation_1, Face_12, 'Face_12' )
geompy.addToStudyInFather( Translation_1, Face_13, 'Face_13' )
geompy.addToStudyInFather( Translation_1, Face_14, 'Face_14' )
geompy.addToStudyInFather( Translation_1, Face_15, 'Face_15' )
geompy.addToStudyInFather( Translation_1, Face_16, 'Face_16' )
geompy.addToStudyInFather( Translation_1, Face_17, 'Face_17' )
geompy.addToStudyInFather( Translation_1, Face_18, 'Face_18' )
geompy.addToStudyInFather( Translation_1, Face_19, 'Face_19' )
geompy.addToStudyInFather( Translation_1, Face_20, 'Face_20' )
geompy.addToStudyInFather( Translation_1, Face_21, 'Face_21' )
geompy.addToStudyInFather( Translation_1, Face_22, 'Face_22' )
...
geompy.addToStudyInFather( Face_16, Edge_9, 'Edge_9' )
geompy.addToStudyInFather( Face_16, Edge_10, 'Edge_10' )
geompy.addToStudyInFather( Face_16, Edge_11, 'Edge_11' )
geompy.addToStudyInFather( Face_16, Edge_12, 'Edge_12' )
...
smesh.SetName(Mesh_1, 'Mesh_1')
try:
  Mesh_1.ExportMED(r'/home/student/software/femus/applications/2021_fall/arani/input/assignment_cylinder_hexahedral.med',auto_groups=0,version=41,overwrite=1,meshPart=None,autoDimension=1)
  pass
except:
  print('ExportMED() failed. Invalid file name?')
